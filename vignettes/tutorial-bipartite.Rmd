...
We load a list of 15 plant-pollinisator networks. They are binary undirected networks with different
number of plant and pollinisator species. First, we are going to model jointly the first $3$ networks,
...
your goal is dyad prediction, then you should use `model = "delta"`, instead of
`model = "iid"`.
