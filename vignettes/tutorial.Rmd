...
```{r}
best_fit$pred_dyads[[3]][1:10, 1:5] |> round(3)
```
...
We simulate some directed networks with a lower triangular structure that looks 
alike foodwebs.
...
We can  also compare the mesoscale structures of the 2 groups:
