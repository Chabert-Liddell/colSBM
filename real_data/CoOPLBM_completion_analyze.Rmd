...
$$\widehat{M_{ij}} = \matchbb{P}(M_{ij} = 1)$$
...
ARI(uncompleted_clusterings[which(uncompleted_clusterings$model == "iid"), ]$collection_id, point_5_clusterings[which(point_5_clusterings$model == "iid"), ]$collection_id)
```
...
### ARI of networks clustering: 0.5 threshold vs raw data
