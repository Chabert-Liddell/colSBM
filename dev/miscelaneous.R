...
res <- estimate_colSBM(foodwebs[4:8],
  colsbm_model = "pi", directed = TRUE, model = "bernoulli",
  global_opts = list("verbosity" = 2, "plot_details" = 1, "Q_max" = 10L), nb_run = 1
)
res_cl2 <- clusterize_networks(foodwebs,
  colsbm_model = "iid", directed = TRUE, model = "bernoulli",
